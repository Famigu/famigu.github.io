...
function validaEmailDesk(){
  email = document.getElementById("emailDesk").value.trim();
  if(email == ""){
...
function validaNomeDesk(){
  nome = document.getElementById("nomeDesk").value.trim();
  if(nome == ""){
...
function validaTelefoneDesk(){
  email = document.getElementById("foneDesk").value.trim();
  if(email == ""){
...
function validaMensagemDesk(){
  mensagem = document.getElementById("mensagemDesk").value.trim();
  if(mensagem == ""){
...
function validaEmailMobile(){
  email = document.getElementById("emailMobile").value.trim();
  if(email == ""){
...
function validaNomeMobile(){
  nome = document.getElementById("nomeMobile").value.trim();
  if(nome == ""){
...
function validaTelefoneMobile(){
  email = document.getElementById("foneMobile").value.trim();
  if(email == ""){
...
function validaMensagemMobile(){
  mensagem = document.getElementById("mensagemMobile").value.trim();
  if(mensagem == ""){
